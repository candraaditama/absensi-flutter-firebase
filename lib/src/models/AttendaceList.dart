  ...
  AttendanceList.fromJson(
    ...
    if (dataSnapshot != null) {
      dataSnapshot.cast<String, dynamic>().forEach((key, value) {
        ...
        attendanceList.add(
            Attendance(type: type,  lat: lat.replaceAll(",", "."), long: long.replaceAll(",", "."), time: time, office: map[value["office"]] ));
      });
    }
...
class Attendance {
  ...
  Attendance({this.type, this.lat, this.long, this.time, this.office});
}

      ...
      body: ListView(
        children: <Widget>[
          if(_imageFile==null) ...[
            Container(
              child: Center(
                child: Text("KLIK TOMBOL CAMERA UNTUK UPLOAD GAMBAR"),
              ),
            )
          ],
...
class _UploaderState extends State<Uploader> {
  ...
  FirebaseStorage(storageBucket: 'gs://absensi-mirota.appspot.com');

  StorageUploadTask _uploadTask;
  _startUpload() {
    int randomNumber = Random().nextInt(100000);
    //String filePath = 'images/${DateTime.now().toString().replaceAll(":", ".")}.jpg';
    String filePath = 'images/image$randomNumber.jpg';
    setState(() {

...
import 'package:geo_attendance_system/src/ui/pages/leave_application.dart';
import 'package:geo_attendance_system/src/ui/pages/leave_status.dart';
...
class _DashboardState extends State<Dashboard> {
  //posisi homepage jika menu di klik
  static const header_height = 0.0;
    ...
    return Container(
        ...
        child: ListView(
          children: <Widget>[
                  ...
                  case ConnectionState.done:
                    if (snapshot.hasError)
                      ...
                      return Stack(children: [
                        drawerTile("Lokasi Absen: ${snapshot.data}",
                ...
                switch (snapshot.connectionState) {
                  ...
                  case ConnectionState.done:
                    ...
                    if (snapshot.data.value == null || snapshot.data.value == 1)
                      return Stack(children: [
                        drawerTile("Review Cuti", () {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) =>
                                  LeaveApprovalByManagerWidget(
                                    title: "Review Cuti (BETA)",
                                    user: widget.user,
                                  )));
                        }, Icons.perm_identity),
                        Positioned(
            ...
            drawerTile("Ubah Profile", () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => ProfilePage(
                        user: widget.user,
                      )));
            }, Icons.perm_identity),
            drawerTile("Pengajuan Cuti", () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => LeaveApplicationWidget(
                    user: widget.user,
                  )));
            }, Icons.email),
            drawerTile("Status Cuti", () {
              Navigator.of(context).push(MaterialPageRoute(

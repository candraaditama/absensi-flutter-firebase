...
class AttendanceRecorderWidgetState extends State<AttendanceRecorderWidget> {
  ...
  Widget googleMap(BuildContext context) {
    ...
    double _initialLong = 110.434585;
    ...
    return Padding(
      ...
      child: Align(
        ...
        child: Row(
          ...
          children: <Widget>[
            inOutButton("Check-In", Colors.white, _callMarkInFunction),
            Spacer(flex: 20),
            OutButton("Pulang", Colors.white, _callMarkOutFunction),
          ],
        ),
      ),
    );
      ...
      showDialog(
          ...
          child: Dialog(
            child: Container(
              ...
              child: Center(
                  child: Text(
                "Status geografis Anda tidak diketahui. Silahkan coba beberapa saat lagi, atau restart aplikasi !",
